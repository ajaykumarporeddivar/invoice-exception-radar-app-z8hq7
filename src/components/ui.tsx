  ...
  return (
    <button
      className={cn(
        ...
        variant === 'ghost' && 'text-zinc-600 hover:bg-zinc-50',
        className,
      )}
      {...props}
    />
...
export function Card({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return <div className={cn('rounded-xl border border-zinc-200 bg-white shadow-sm p-5', className)} {...props} />
}
...
export function Input({ className, ...props }: React.InputHTMLAttributes<HTMLInputElement>) {
  return <input className={cn('w-full rounded-md border border-zinc-200 bg-white px-3 py-2 text-sm outline-none focus:border-zinc-900 text-zinc-900 placeholder:text-zinc-400', className)} {...props} />
}

export function Textarea({ className, ...props }: React.TextareaHTMLAttributes<HTMLTextAreaElement>) {
  return <textarea className={cn('w-full rounded-md border border-zinc-200 bg-white px-3 py-2 text-sm outline-none focus:border-zinc-900 text-zinc-900 placeholder:text-zinc-400', className)} {...props} />
}
